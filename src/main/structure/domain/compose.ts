...
import { basementHeight, composeBasementStack, selectedBasement } from './compose-basement';
import type { GeometryModule } from './geometry-module';
import { resolveParams, sanitizeWH, type ParamValues } from './params';
...
// The central-basement machinery lives in compose-basement.ts; re-exported here so the
// domain barrel (and any older importer) keeps finding it on compose's public surface.
export { basementHeight, selectedBasement } from './compose-basement';
