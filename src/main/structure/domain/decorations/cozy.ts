...
// cohesive warm palette so any structure type (house, tower) reads as inviting
// rather than ruined. This is the default (and, for now, only) decoration.
