...
4. **Circulation:** an open interior stair (or a clean flush ladder) linking the floors,
   plus exterior steps up to the entrance / terrace.

## Avoid

- Re-roofing it with a gable/hip or capping it as a solid box.
- Re-cladding the white shell in spruce/oak planks or cobblestone (that's the cozy look).
- Small punched windows in place of the glass curtain walls.
- Clutter — hold the palette to white + one dark accent + wood + glass + greenery.
